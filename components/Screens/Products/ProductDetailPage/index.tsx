          ...
          <div className="goods-summary__container">
            ...
            <div className="flex gap-x-4">
              ...
              <div className="goods-reviews">
                ...
                <span className="text-[#FACF19] -mt-4">
                  &#40;1000+ Reviews&#41;
                </span>
              </div>
            </div>
            ...
            <div className="product-intro">
              ...
              <div className="product-intro__size mt-3">
                      ...
                      {selectedProduct.sizes?.map((size) => (
                        ...
                        >
                          <div
                            ...
                            onClick={() => setSelectedSize(size.filterOptions)}
                          >
                            {size.filterOptions}
                          </div>
                        </Popover>
                ...
                <div className="mt-[13px]">
                  <button
                    className="bg-black text-white w-full min-w-[390px] max-w-[395px] px-6 py-4 mt-2 text-lg uppercase font-bold"
                    disabled={isLoading}
                    onClick={addToCart}
                  >
                    {" "}
            ...
            {openFilterItem && (
              <div className="side-filter__item__content max-w-[385px] w-full">
                <p>
                  ...
                  pariatur fuga voluptatibus consectetur impedit? Perferendis,
                  quae repellendus similique iure excepturi minus laboriosam
                  dicta cum distinctio quidem sit praesentium itaque voluptate.
                </p>
              </div>
            )}
          </div>
