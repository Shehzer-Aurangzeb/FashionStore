...
function ProductDetailPage({ selectedProduct }: IProps) {
  ...
  return (
    <div className={`md:px-12 px-2 w-full mx-auto`}>
      {/* for popup message */}
      {contextHolder}
      {width > 770 ? (
        ...
        <div className="flex flex-col relative text-gray-dark justify-center w-full mx-auto product-intro">
          <div
            className={`relative product-intro__galleryWrap sm:w-full sm:max-w-[600px] mx-auto max-w-[400px]`}
          >
            <Slider
              slidesPerView={1}
              ref={swiper}
          ...
          <div className="quick-view-des product-intro__info pt-[2%] sm:ml-14 ml-0">
            <div className="sticky top-[100px] z-[1]">
              <div className="relative mb-[25px] product-intro__head">
                <h1 className="product-intro__head-name">
                  {selectedProduct.productDetails}
                ...
                {openProductDetailsAccordion.description && (
                  <div className="side-filter__item__content max-w-[385px] w-full">
                    <p>
                      ...
                      Perferendis, quae repellendus similique iure excepturi
                      minus laboriosam dicta cum distinctio quidem sit
                      praesentium itaque voluptate.
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="relative w-full overflow-hidden mx-auto sm:ml-14 ml-0">
            <h1 className="text-2xl font-bold pt-[30px] pb-[16px] capitalize">
              Customer Reviews
            </h1>
            <div className="flex items-center bg-[#F7F8FA] px-[18px] py-3">
