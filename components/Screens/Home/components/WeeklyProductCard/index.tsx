  ...
  return (
    ...
    >
      ...
      <div className="bg-prouduct-price-mask text-center absolute bottom-0 w-full h-[29%] flex items-end justify-center">
        <div className="text-center bg-white rounded-[46px] px-1 py-[2px] mb-[9.8%] text-[#fa6338] text-xs font-bold leading-[14px] overflow-hidden text-ellipsis whitespace-nowrap h-[18px] inline-block max-w-[calc(100%_-_8px)] ">
          {price}
        </div>
      </div>
    </Link>
