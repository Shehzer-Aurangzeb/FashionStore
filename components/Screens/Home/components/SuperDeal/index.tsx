    ...
    <div className="mb-3 rounded-md relative overflow-hidden">
      ...
      <div className="flex justify-between m-4">
        <div className="relative overflow-hidden w-[149px] h-[29px]">
          <Link href={"/"} className="w-full block">
            <Image
              src={
                "https://img.ltwebstatic.com/images3_ccc/2024/03/19/5f/1710834624f0667531123db441331e5d08509d111c_thumbnail_192x.webp"
              }
              alt=""
              fill
            />
        ...
        <div className="flex text-right items-center text-xl font-normal  text-[#5E3333]">
          <span className="text-ellipsis overflow-hidden whitespace-nowrap text-xl font-normal">
            View more
          </span>
      ...
      <div className="super-sale-products m-4 mt-0 w-full pr-8">
        <div className="mx-auto relative overflow-hidden z-[1]">
          ...
          >
            {SUPERDEALPRODUCTS.map(
              ({ label, mainImage, subMainImage, price }, key) => (
                <SwiperSlide key={key}>
                  <Product
                    label={label}
                    mainImage={mainImage}
                    subMainImage={subMainImage}
                    isSuperDealProduct={true}
                    url=""
                  >
