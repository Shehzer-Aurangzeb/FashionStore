...
function Left() {
  return (
    <div className="max-w-[332px] w-[calc(50%_-_5.5px)] md:w-[calc(50%_-_11px)] h-auto relative">
      <div className="rounded-md overflow-hidden bg-[#f0f0f0]">
        <Link href={"/"} className="w-full pb-[94.5%] block relative">
          <Image
            src={"https://img.ltwebstatic.com/images3_ccc/2024/04/29/d0/171437126794aa23acd2947b8a8697e7c60818103b_thumbnail_832x.webp"}
            alt="discount"
            fill
            className="bg-white object-cover align-top box-border"
          />
