...
function CategoryItem({ image, title, onClick }: IProps) {
  return (
    <p
      onClick={onClick}
      className="grow-0 shrink-0 basis-[calc(100%_/_7)] py-[5px] pr-[2px] pl-0 text-center mb-2 inline-block w-[88px] align-top text-gray-light nav_type_img_link cursor-pointer"
    >
